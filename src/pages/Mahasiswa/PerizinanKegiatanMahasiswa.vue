  ...
  <div class="root-class">
    <div class="header">
      <h3 class="header-page">
        Buat Perizinan<span style="color: grey"> >> Kegiatan</span>
      </h3>
    ...
    <div class="formulir">
      <form v-on:submit.prevent="postIzinKegiatan" id="formKegiatan">
        <div class="form-row">
          <div class="col-12 col-md-6 px-4 py-2">
            <label for="inputNamaKegiatan"
              >Nama Kegiatan<span class="text-danger">*</span></label
            >
            <input
              type="text"
              class="form-control"
          ...
          <div class="col-12 col-md-6 px-4 py-2">
            <label for="inputTempatPelaksanaan"
              >Tempat Pelaksanaan<span class="text-danger">*</span
        ...
        <div class="form-row">
          ...
          <div class="col-12 col-md-6 px-4 py-2">
            ...
            <label for="inputEmailPic"
              >Email PIC<span class="text-danger">*</span>:</label
            >
            <input
              type="email"
              class="form-control"
        ...
        <div class="form-row">
          <div class="col-12 col-md-6 px-4 py-2">
            <label for="inputSumberPendanaan"
              >Sumber Pendanaan<span class="text-danger">*</span></label
            >
            <input
              type="text"
              class="form-control"
        ...
        <div class="form-row">
          ...
          <div class="col-12 col-md-6 px-4 py-2">
            <label for="inputButuhRuangn"
              >Apakah anda memerlukan humas?
              <span class="text-keterangan">
                (Publikasi, Souvenir, Protokoler)</span
              >
            </label>
            <br /><input
              v-model="kebutuhan"
        ...
        <div>
          <div class="text-right">
            <input
              class="btn btn-success btn-simpan"
              type="submit"
              value="Simpan"
            />
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <div class="text-center">
              <router-link
                :to="{
                  path: this.path_selanjutnya,
                  name: this.nama_path,
                  params: this.params_path,
                }"
              >
                <div class="text-center">
                  <button
                    @click="onCloseModal('#notification-success')"
                    id="button-modal"
                    type="button"
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <div class="text-center">
              <button
                type="button"
                @click="onCloseModal('#notification-failed')"
  ...
  methods: {
    ...
    checkDate() {
      ...
      if (tanggal_akhir < tanggal_mulai) {
        this.error_message =
          "Tanggal atau waktu yang Anda masukkan salah. Tanggal dan waktu mulai kegiatan harus lebih dulu dari tanggal dan waktu akhir kegiatan";
        $("#notification-failed").modal("show");
        passed = false;
      }
      return passed;
      ...
      if (this.checkDate() && this.checkEmail()) {
        UserService.postIzinKegiatanHeader(data_kegiatan).then(
          (response) => {
            ...
            let waktu_tanggal_mulai =
              this.tanggal_mulai + "T" + this.waktu_mulai;
            formDataDetail.append("waktu_tanggal_mulai", waktu_tanggal_mulai);
            let waktu_tanggal_akhir =
              this.tanggal_akhir + "T" + this.waktu_akhir;
            ...
            UserService.postIzinKegiatanDetail(formDataDetail).then(
              (response) => {
                ...
                if (this.kebutuhan.length == 0) {
                  ...
                  this.kebutuhan[0] == "ruangan" ||
                  (this.kebutuhan.length > 1 && this.kebutuhan[1] == "ruangan")
                ) {
                  this.pesan_button = "Ke halaman perizinan ruangan";
                  this.path_selanjutnya =
                    "/buat-perizinan/form-ruangan-mahasiswa/";
                  this.nama_path = "Form Peminjaman Ruangan Mahasiswa";
                  this.params_path = {
                    id_izin_kegiatan: this.respon_kegiatan.id,
