  ...
  <div class="card fmed" style="min-height: 600%">
    <div class="d-flex">
      <div class="mr-auto p-3">
        <h4 class="judul p-1 align-middle" style="font-weight: 500">
          Daftar Perizinan
        </h4>
      </div>
      <div class="p-3"></div>
    ...
    <div style="margin: 1% 7%">
      <div class="table-responsive">
        ...
        >
          <thead
            class="thead kuning rounded-top"
            style="border-radius: 10px 10px 0px 0px"
          >
          ...
          <tbody class="fsmall">
            ...
            <tr>
              <td>Status</td>
              <td v-if="perizinan.status_perizinan_kegiatan == 1">
                Menunggu Persetujuan
              </td>
              <td v-if="perizinan.status_perizinan_kegiatan == 2">Disetujui</td>
              <td v-if="perizinan.status_perizinan_kegiatan == 3">
                Ditolak
                <a
                  data-toggle="modal"
                  class="btn tambah"
                  style="padding: 1px 3px; font-size: 12px"
                  data-target="#popup-izin-kegiatan"
                  >edit</a
                >
              </td>
              ...
              <template v-if="perizinan.detail_kegiatan != null">
                <div
                  ...
                  id="popup-izin-kegiatan"
                  tabindex="-1"
                  role="dialog"
                  aria-labelledby="popup-protokoler"
                  aria-hidden="true"
                >
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <form>
                        <div class="form-row">
                          <div class="col-12 col-md-6 px-4 py-2">
                            ...
                            <input
                              type="text"
                              class="form-control"
                              placeholder="e.g. Open House FEB UI"
                              required
                              v-model="nama_kegiatan"
                            />
                          </div>
                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputTempatPelaksanaan"
                              >Tempat Pelaksanaan<span class="text-danger"
                                >*</span
                              >:
                              <span class="text-keterangan">
                                (jika kegiatan online, isi: "Online")</span
                              ></label
                            >
                            <template v-if="perizinan.detail_kegiatan != null">
                              <input
                                type="text"
                                class="form-control"
                                placeholder="e.g. FEB UI"
                                v-model="tempat_pelaksanaan"
                                required
                              />
                            </template>
                          </div>
                        ...
                        <div class="form-row">
                          <div class="col-12 col-md-6 px-4 py-2">
                            ...
                            <input
                              type="datetime-local"
                              class="form-control"
                              v-model="waktu_tanggal_mulai"
                              required
                            />
                          </div>

                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputTanggalAkhir"
                        ...
                        <div class="form-row">
                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputOrganisasi"
                              >Organisasi Penanggungjawab<span
                                class="text-danger"
                                >*</span
                              >:</label
                            >
                        ...
                        <div class="form-row">
                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputKetuaOrganisasi"
                              >Nama Ketua Organisasi<span class="text-danger"
                                >*</span
                              >:</label
                            >
                            <input
                          ...
                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputNpmKetuaOrganisasi"
                              >NPM Ketua Organisasi<span class="text-danger"
                                >*</span
                              >:</label
                            >
                            <input
                        ...
                        <div class="form-row">
                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputPicKegiatan"
                              >Nama PIC Kegiatan<span class="text-danger"
                                >*</span
                              >:</label
                            >
                            <input
                              type="text"
                              class="form-control"
                              placeholder="e.g. Akhmad"
                              v-model="nama_pic"
                              required
                            />
                          </div>
                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputNpmPic"
                              >NPM PIC<span class="text-danger">*</span>:</label
                            >
                            <input
                              type="text"
                              class="form-control"
                        ...
                        <div class="form-row">
                          <div class="col-12 col-md-6 px-4 py-2">
                            ...
                            <input
                              type="email"
                              class="form-control"
                              placeholder="e.g. akhmad@ui.ac.id"
                              v-model="email_pic"
                              required
                            />
                          </div>
                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputHpPic"
                              >HP PIC<span class="text-danger">*</span>:</label
                            >
                            <input
                              type="text"
                              pattern="^[0-9]+$"
                              class="form-control"
                              placeholder="e.g. 08151234567"
                              v-model="hp_pic"
                              required
                            />
                          </div>
                        ...
                        <div class="form-row">
                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputSumberPendanaan"
                              >Sumber Pendanaan<span class="text-danger">*</span
                              >:</label
                            >
                            <input
                              type="text"
                              ...
                              v-model="sumber_pendanaan"
                              required
                            />
                          </div>
                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputUploadDokumen"
                              >Upload Dokumen<span class="text-danger">*</span
                              >:<span class="text-keterangan">
                                (contoh: TOR-JGTC.pdf; Dokumen-JGTC.zip)</span
                              ></label
                            >
                            <input
                              id="file_info"
                            ...
                            />
                            <p
                              v-if="this.file_info_kegiatan != null"
                              class="text-right note-form"
                              @Click="deleteFileInfo()"
                            >
                              Hapus File
                            </p>
                          </div>
                      ...
                      <div class="modal-footer">
                        ...
                        <div class="text-center">
                          <button
                            ...
                            style="width: 80px; height: 36px"
                            v-on:click="
                              editIzinKegiatan(perizinan.id);
                              editDetailIzinKegiatan(
                                perizinan.detail_kegiatan.id,
                                perizinan.id
                              );
                            "
                          >
        ...
        <div class="d-flex bd-highlight">
          ...
          <div class="p-2 bd-highlight">
            <a class="ml-auto" :href="'/detail-kegiatan/' + perizinan.id">
              Detail Izin Kegiatan>></a
            >
          </div>
        </div>
      </div>
      ...
      <div class="table-responsive">
        ...
        >
          ...
          <tbody class="fsmall">
            ...
            <template
              v-for="peminjaman in list_peminjaman_ruangan.length"
              v-bind:key="peminjaman.id"
            >
              <tr>
                <td class="text-center">
                  {{ list_peminjaman_ruangan[peminjaman - 1].judul_peminjaman }}
                </td>
                <td class="text-center">
                  {{ list_peminjaman_ruangan[peminjaman - 1].ruangan }}
                </td>
                ...
                <template v-if="peminjaman.perulangan != null">
                  <td class="text-center">
                    {{
                      getDateDef(
                        list_peminjaman_ruangan[peminjaman - 1].perulangan
                          .tanggal_mulai
                      )
                    }}
                  </td>
                ...
                <td class="text-center">
                  {{
                    getHour(list_peminjaman_ruangan[peminjaman - 1].waktu_mulai)
                  }}
                  -
                  {{
                    getHour(list_peminjaman_ruangan[peminjaman - 1].waktu_akhir)
                  }}
                </td>
                <template
                  v-if="
                ...
                <td
                  class="text-center"
                  v-if="
                    list_peminjaman_ruangan[peminjaman - 1]
            ...
            <div v-if="indexPeminjamanRuangan != null">
              <div
                class="modal fade"
                id="popup-peminjaman-ruangan"
                tabindex="-1"
                role="dialog"
                aria-labelledby="popup-penolakan"
                aria-hidden="true"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    <form>
                      <div class="form-row">
                        <div class="col-12 col-md-6 px-4 py-2">
                          <label for="inputSubkegiatan"
                            >Nama Subkegiatan<span class="asterisk"
                              >*</span
                            ></label
                          >
                          <input
                            type="text"
                            class="form-control"
                            placeholder="e.g. Administrasi Bisnis - B"
                            v-model="
                              list_peminjaman_ruangan[indexPeminjamanRuangan]
                                .judul_peminjaman
                            "
                          />
                        </div>
                        <div class="col-12 col-md-6 px-4 py-2">
                          <label for="inputJumlahPeserta"
                            >Jumlah Peserta<span class="asterisk"
                              >*</span
                            ></label
                          >
                          <input
                      ...
                      <div class="form-row">
                        <div class="col-12 col-md-6 px-4 py-2">
                          <label for="waktuMulaiPeminjaman"
                            >Waktu mulai<span class="asterisk">*</span></label
                          >
                          <select
                            class="form-control"
                            id="waktuMulaiPeminjaman"
                            v-model="
                              list_peminjaman_ruangan[indexPeminjamanRuangan]
                                .waktu_mulai
                            "
                        ...
                        <div class="col-12 col-md-6 px-4 py-2">
                          <label for="waktuAkhirPeminjaman"
                            >Waktu akhir<span class="asterisk">*</span></label
                          >
                          <select
                            class="form-control"
                            id="waktuAkhirPeminjaman"
                            v-model="
                              list_peminjaman_ruangan[indexPeminjamanRuangan]
                                .waktu_akhir
                            "
                      ...
                      <div class="form-row">
                        <div class="col-12 col-md-6 px-4 py-2">
                          <label for="tanggalMulaiPelaksanaan"
                            >Tanggal Mulai Pelaksanaan<span class="asterisk"
                              >*</span
                            ></label
                          >
                          <input
                            ...
                            <input
                              ...
                              v-model="
                                list_peminjaman_ruangan[indexPeminjamanRuangan]
                                  .terbuka_untuk_umum
                              "
                              id="checkbox-terbuka-untuk-umum"
                            />
                            <label
                        ...
                        <div class="col-12 col-md-6 px-4 py-2">
                          <label for="tanggalAkhirPelaksanaan"
                            >Tanggal Akhir Pelaksanaan<span class="asterisk"
                              >*</span
                            ></label
                          >
                          <input
                            ...
                            v-model="
                              list_peminjaman_ruangan[indexPeminjamanRuangan]
                                .perulangan.tanggal_akhir
                            "
                          />
                          <p class="note-form">
                            isi dengan tanggal yang sama dengan tanggal mulai
                            pelaksanaan jika memilih "sekali pakai"
                          </p>
                        </div>
                      </div>
                    </form>
    ...
    <div style="margin: 1% 7%">
      <div class="table-responsive">
          ...
          >
            <tr style="border-radius: 10px">
              <th
                ...
                style="border-radius: 5px 5px 0px 0px"
              >
                Informasi Publikasi, Souvenir, dan Protokoler
              </th>
            </tr>
          </thead>
        </table>
        <div class="d-flex">
          ...
          <template
            v-if="perizinan.perizinan_publikasi.jenis_izin_publikasi != null"
          >
            <div class="ml-auto">
              <a
                data-toggle="modal"
                class="btn tambah"
                style="padding: 1px 3px; font-size: 12px"
                data-target="#popup-perizinan-publikasi"
                >edit</a
              >
            </div>
          </template>
        ...
        <table
          v-if="perizinan.perizinan_publikasi == null"
          class="table table-sm table-bordered mt-2 fsmall"
          style="border-radius: 10px 10px 0px 0px"
        >
          <tr>
        ...
        >
          ...
          <tr>
            <td
              :rowspan="
                perizinan.perizinan_publikasi.jenis_izin_publikasi.length + 1
              "
              class="align-middle text-center"
            >
              {{ getDateDef(perizinan.perizinan_publikasi.tanggal_mulai) }}
            </td>
            <td
              :rowspan="
                perizinan.perizinan_publikasi.jenis_izin_publikasi.length + 1
              ...
              class="align-middle text-center"
            >
              {{ getDateDef(perizinan.perizinan_publikasi.tanggal_akhir) }}
            </td>
            <td
              :rowspan="
                perizinan.perizinan_publikasi.jenis_izin_publikasi.length + 1
              ...
              class="align-middle text-center"
            >
              {{ perizinan.perizinan_publikasi.keterangan }}
            </td>
          </tr>
          <template
            v-for="pub in perizinan.perizinan_publikasi.jenis_izin_publikasi"
            v-bind:key="pub.id"
          >
            <tr>
              <td v-if="pub.jenis_publikasi.luar_ruangan == true">
                {{ pub.jenis_publikasi.deskripsi_publikasi }}
              </td>
              <td v-if="pub.jenis_publikasi.luar_ruangan == true">-</td>

              <td v-if="pub.jenis_publikasi.luar_ruangan == false">-</td>
              <td v-if="pub.jenis_publikasi.luar_ruangan == false">
                {{ pub.jenis_publikasi.deskripsi_publikasi }}
              </td>

              <td
                class="text-center"
                v-if="pub.status_perizinan_publikasi == 1"
              >
                Menunggu Persetujuan
              </td>
              <td
                class="text-center"
                v-if="pub.status_perizinan_publikasi == 2"
              >
                Disetujui
              </td>
              <td
                class="text-center"
                v-if="pub.status_perizinan_publikasi == 3"
              >
                Ditolak
                <!-- Modal: Popup Edit Permintaan Protokoler -->
                <div
                  class="modal fade bd-example-modal-lg"
                  id="popup-perizinan-publikasi"
                  tabindex="-1"
                  role="dialog"
                  aria-labelledby="popup-protokoler"
                  aria-hidden="true"
                    ...
                    <div class="modal-content">
                      <form>
                        <div class="border-form">
                          <div class="form-row">
                            <div class="col-12 col-md-6 px-4 py-2">
                              <label for="inputPublikasiLuarRuangan"
                                >Publikasi Luar Ruangan</label
                              >
                              <span
                                v-for="publikasi in publikasi_luar_ruangan"
                                v-bind:key="publikasi.id"
                              >
                                <input
                                  id="input_publikasi"
                                  v-model="jenis_publikasi"
                                  type="checkbox"
                                  :value="publikasi"
                                />
                                <span class="checkbox-label">{{
                                  publikasi.deskripsi_publikasi
                                }}</span
                                ><br />
                              </span>
                            </div>
                          ...
                          <div class="form-row">
                            <div class="col-12 col-md-6 px-4 py-2">
                              <label for="inputKeterangan"
                                >Keterangan
                                <span class="text-keterangan"
                                  >(Harap isi jenis dan lokasi publikasi disini,
                                  jika memilih "Lainnya")</span
                                ></label
                              >
                              <textarea
                                id="input_keterangan"
                                ...
                                v-model="keterangan"
                                class="form-control"
                                placeholder="e.g. Baliho di Depan Gedung x ukuran (axb)"
                              ></textarea>
                            </div>
                            <div class="col-12 col-md-6 px-4 py-2">
                              <label for="inputMateriKegiatan"
                                >Materi Kegiatan / Press Release:<span
                                  class="text-keterangan"
                                >
                                  (Dapat diunggah dalam format zip)</span
                                >
                              </label>
                              <input
                                id="file_materi"
                                type="file"
                                ref="fileMateri"
                                @change="onFileMateriChange"
                                class="form-control-file"
                              />
                              <p
                                v-if="this.file_materi_kegiatan != null"
                                class="text-right note-field"
                                @Click="deleteFileMateri()"
                              >
                                Hapus File
                              </p>
                              <label for="inputFlyerPengumuman"
                                >Flyer Pengumuman / Poster Kegiatan:<span
                                  class="text-keterangan"
                                >
                                  (jika ada)</span
                                ></label
                              ...
                              <input
                                ...
                                type="file"
                                ref="fileFlyer"
                                @change="onFileFlyerChange"
                                class="form-control-file"
                              />
                              <p
                                v-if="this.file_flyer_pengumuman != null"
                                class="text-right note-field"
                                @Click="deleteFileFlyer()"
                              >
                                Hapus File
                              </p>
                            </div>
                          ...
                          <div class="form-row">
                            <div class="col-12 col-md-6 px-4 py-2">
                              <label for="inputTanggalMulai"
                                >Tanggal Mulai<span class="text-danger"
                                  >*</span
                                ></label
                              >
                              <input
                                id="input_tanggal_mulai"
                                v-model="tanggal_mulai_publikasi"
                                type="date"
                                class="form-control"
                              />
                            </div>
                            <div class="col-12 col-md-6 px-4 py-2">
                              <label for="inputTanggalAkhir"
                                >Tanggal Akhir<span class="text-danger"
                                  >*</span
                                ></label
                              >
                              <input
                                id="input_tanggal_akhir"
                                v-model="tanggal_akhir_publikasi"
                                type="date"
                                class="form-control"
                              />
                            </div>
                      ...
                      <div class="modal-footer">
                        ...
                        <div class="text-center">
                          <button
                            ...
                            style="width: 80px; height: 36px"
                            v-on:click="
                              editPerizinanPublikasi(
                                perizinan.perizinan_publikasi.id,
                                perizinan.id
                              )
                            "
                          >
      ...
      <div class="table-responsive">
        <table
          v-if="perizinan.permintaan_protokoler == null"
          class="table table-sm table-bordered mt-2 fsmall"
          style="border-radius: 10px 10px 0px 0px"
        >
          <tr>
        ...
        >
          ...
          <template
            v-for="souv in list_permintaan_souvenir.length"
            v-bind:key="souv.id"
          >
            <tr>
              <td>
                {{ list_permintaan_souvenir[souv - 1].nama_penerima_souvenir }}
              </td>
              <td>
                {{
                  list_permintaan_souvenir[souv - 1].jabatan_penerima_souvenir
                }}
              </td>
              <td>
                {{ list_permintaan_souvenir[souv - 1].kelas_penerima_souvenir }}
              </td>
              ...
              <td
                class="text-center"
                v-if="
                  list_permintaan_souvenir[souv - 1]
              ...
              >
                ...
                <button
                  ...
                  class="btn tambah"
                  style="padding: 1px 3px; font-size: 12px"
                  data-target="#popup-permintaan-souvenir"
                  @Click="openModalSouvenir(souv - 1)"
                >
                  edit
                </button>
              </td>
                    ...
                    <div class="modal-body">
                      <div class="form-row">
                        <div class="col-12 px-4">
                          <label>
                            Souvenir<span class="text-keterangan">
                              (semua field wajib diisi jika mengajukan
                              permintaan souvenir)</span
                            ></label
                          >
                          <hr />
                        </div>
                        ...
                        <div class="form-row">
                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputNamaPenerima"
                              >Nama Penerima:<span class="text-danger"
                                >*</span
                              ></label
                            >
                            <input
                              pattern="[A-Za-z]"
                              id="input_nama_penerima"
                              type="text"
                              v-model="
                                list_permintaan_souvenir[
                                  indexPermintaanSouvenir
                          ...
                          <div class="col-12 col-md-6 px-4 py-2">
                            <label for="inputJabatanPenerima"
                              >Jabatan Penerima:<span class="text-danger"
                                >*</span
                              ></label
                            >
                            <input
                              id="input_jabatan_penerima"
                              type="text"
                              v-model="
                                list_permintaan_souvenir[
                                  indexPermintaanSouvenir
                              ...
                              "
                              class="form-control = $event.target.value"
                              placeholder="e.g. Menteri"
                            />
                          </div>
                        </div>
                        <div class="col-12 col-md-6 px-4 py-2">
                          ...
                          <select
                            ...
                            v-model="
                              list_permintaan_souvenir[indexPermintaanSouvenir]
                      ...
                      <div class="form-row">
                        <div class="col-12 col-md-6 px-4 py-2">
                          <label for="inputPilihanSouvenir"
                            >Pilihan Souvenir:<span class="text-danger"
                              >*</span
                            ></label
                          >
                          <select
                          ...
                          >
                            <option selected disabled value="">Pilih...</option>
                            <option
                              v-for="pilihan_souvenir in souvenir_data_filtered"
                              v-bind:key="pilihan_souvenir.id"
                              :value="pilihan_souvenir.id"
                            >
                              {{ pilihan_souvenir.nama_souvenir }}
                            </option>
                          </select>
                        </div>
                        <div class="col-12 col-md-6 px-4 py-2">
                  ...
                  <div class="modal-footer">
                    ...
                    <div class="text-center">
                      ...
                      >
                        Simpan
                        {{
                          list_permintaan_souvenir[indexPermintaanSouvenir].id
                        }}
                      </button>
                    </div>
                  </div>
        ...
        >
          ...
          <tr>
            ...
            <td
              class="text-center"
              v-if="
                perizinan.permintaan_protokoler.status_permintaan_protokoler ==
                1
              "
            >
              Menunggu Persetujuan
            ...
            >
              ...
              <a
                ...
                class="btn tambah"
                style="padding: 1px 3px; font-size: 12px"
                data-target="#popup-permintaan-protokoler"
                >edit</a
              >
            </td>
            <!-- Modal: Popup Edit Permintaan Protokoler -->
            <div
              class="modal fade"
              id="popup-permintaan-protokoler"
              tabindex="-1"
              role="dialog"
              aria-labelledby="popup-protokoler"
              aria-hidden="true"
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <form>
                    <div class="modal-body">
                      <label
                        >Deskripsi Kebutuhan<span style="color: #eb5757"
                          >*</span
                        ></label
                      >
                      <textarea
                        ...
                        id="textarea-keterangan"
                        rows="6"
                        v-model="deskripsi_kebutuhan"
                        placeholder="e.g. Waktu terlalu dekat"
                      ></textarea>
                    </div>
                  </form>
                  <div class="modal-footer">
                    ...
                    <div class="text-center">
                      <button
                        ...
                        style="width: 80px; height: 36px"
                        v-on:click="
                          editPermintaanProtokoler(
                            perizinan.permintaan_protokoler.id
                          )
                        "
                      >
                        Simpan
      ...
      <template v-if="perizinan.peminjaman_ruangan.length != null">
        <template
          v-for="pinjam in perizinan.peminjaman_ruangan"
          v-bind:key="pinjam.id"
        >
          <template v-if="pinjam.alasan_penolakan != null" class="d-flex mb-2">
            <div class="pt-1">Admin Fastur</div>
            <div class="label abu2 ml-4 pl-2 pt-1 komentar align-middle">
      ...
      <template v-if="perizinan.permintaan_souvenir != null">
        <template
          v-for="souvenir in perizinan.permintaan_souvenir"
          v-bind:key="souvenir.id"
        >
          <template
            v-if="souvenir.alasan_penolakan != null"
            class="d-flex mb-2"
          >
            <div class="pt-1">Admin Humas</div>
            <div class="label abu2 pl-2 pt-1 komentar align-middle">
              {{ souvenir.alasan_penolakan }}
            </div>
          </template>
        </template>
      </template>
      <template v-if="perizinan.permintaan_protokoler != null">
        <template
          v-if="perizinan.permintaan_protokoler.alasan_penolakan != null"
          class="d-flex mb-2"
        >
          <div class="pt-1">Admin Humas</div>
          <div class="label abu2 pl-2 pt-1 komentar align-middle">
            {{ perizinan.permintaan_protokoler.alasan_penolakan }}
          </div>
        </template>
      </template>
    </div>
    ...
    <div
      ...
      tabindex="-1"
      role="dialog"
      aria-labelledby="sukses-setuju-modal"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
    ...
    <div
      ...
      tabindex="-1"
      role="dialog"
      aria-labelledby="gagal-submit-modal"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
...
export default {
  ...
  methods: {
    ...
    editPeminjamanRuangan(id, indexPeminjamanRuangan) {
      ...
      const data_put = {
        id: id,
        judul_peminjaman: this.list_peminjaman_ruangan[indexPeminjamanRuangan]
          .judul_peminjaman,
        jumlah_peserta: this.list_peminjaman_ruangan[indexPeminjamanRuangan]
          .jumlah_peserta,
        status_peminjaman_ruangan: 1,
        alasan_penolakan: null,
        waktu_mulai: this.list_peminjaman_ruangan[indexPeminjamanRuangan]
          .waktu_mulai,
        waktu_akhir: this.list_peminjaman_ruangan[indexPeminjamanRuangan]
          .waktu_akhir,
        ...
        terbuka_untuk_umum: this.list_peminjaman_ruangan[indexPeminjamanRuangan]
          .terbuka_untuk_umum,
        perulangan: {
          id: id,
          jenjang: this.list_peminjaman_ruangan[indexPeminjamanRuangan]
            .perulangan.jenjang,
          tanggal_mulai: this.list_peminjaman_ruangan[indexPeminjamanRuangan]
            .perulangan.tanggal_mulai,
          tanggal_akhir: this.list_peminjaman_ruangan[indexPeminjamanRuangan]
            .perulangan.tanggal_akhir,
        },
      };
    ...
    editPerulangan(id, indexPeminjamanRuangan) {
      ...
      const data_put = {
        id: id,
        jenjang: this.list_peminjaman_ruangan[indexPeminjamanRuangan].perulangan
          .jenjang,
        tanggal_mulai: this.list_peminjaman_ruangan[indexPeminjamanRuangan]
          .perulangan.tanggal_mulai,
        tanggal_akhir: this.list_peminjaman_ruangan[indexPeminjamanRuangan]
    ...
    editPerizinanPublikasi(id, id_izin_kegiatan) {
      if (this.jenis_publikasi.length != 0) {
        ...
        if (this.file_materi_kegiatan != null) {
          formDataPublikasi.append(
            "file_materi_kegiatan",
            this.file_materi_kegiatan
          );
        }
        if (this.file_flyer_pengumuman != null) {
          formDataPublikasi.append(
            "file_flyer_pengumuman",
            this.file_flyer_pengumuman
          );
        }
    ...
    editPermintaanSouvenir(id, indexPermintaanSouvenir) {
      ...
      const data_put = {
        ...
        souvenir: this.list_permintaan_souvenir[indexPermintaanSouvenir]
          .souvenir,
        nama_penerima_souvenir: this.list_permintaan_souvenir[
          indexPermintaanSouvenir
        ].nama_penerima_souvenir,
        kelas_penerima_souvenir: this.list_permintaan_souvenir[
          indexPermintaanSouvenir
        ].kelas_penerima_souvenir,
        region_penerima_souvenir: this.list_permintaan_souvenir[
          indexPermintaanSouvenir
        ].region_penerima_souvenir,
        jabatan_penerima_souvenir: this.list_permintaan_souvenir[
          indexPermintaanSouvenir
        ].jabatan_penerima_souvenir,
      };
      console.log(data_put);
      ...
      this.souvenir_data.forEach(function (souvenir) {
        if (kelas_souvenir_diminta == 1) {
          if (
            ...
            if (
              region_souvenir_diminta != "" &&
              (souvenir.region == region_souvenir_diminta ||
                souvenir.region == 3)
            ) {
    ...
    onRegionChange() {
      ...
      if (this.kelas_penerima_souvenir != "") {
        ...
        let region_souvenir_diminta = this.permintaan_souvenir
          .region_penerima_souvenir;
        let souvenir_data_filtered = [];
        this.souvenir_data.forEach(function (souvenir) {
          if (
  ...
  mounted() {
    ...
    UserService.getPerizinan(this.$route.params.id).then(
      (response) => {
        ...
        //detail_kegiatan:""
        this.waktu_tanggal_mulai =
          response.data.detail_kegiatan.waktu_tanggal_mulai;
        this.waktu_tanggal_akhir =
          response.data.detail_kegiatan.waktu_tanggal_akhir;
        ...
        this.npm_ketua_organisasi =
          response.data.detail_kegiatan.npm_ketua_organisasi;
        this.nama_ketua_organisasi =
          response.data.detail_kegiatan.nama_ketua_organisasi;
        this.tempat_pelaksanaan =
          response.data.detail_kegiatan.tempat_pelaksanaan;
        ...
        this.deskripsi_kebutuhan =
          response.data.perizinan_publikasi.deskripsi_kebutuhan;
        this.tanggal_mulai_publikasi =
          response.data.perizinan_publikasi.tanggal_mulai;
        this.tanggal_akhir_publikasi =
          response.data.perizinan_publikasi.tanggal_akhir;
        this.deskripsi_kebutuhan =
          response.data.permintaan_protokoler.deskripsi_kebutuhan;
      },
      (error) => {
        console.log(error.message);
      }
